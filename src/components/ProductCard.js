...
function ProductCard({ item, imgSrc }) {
  ...
  return (
    <>
      ...
      >
        <div className="product-img-wrap">
          {imgSrc ? (
            ...
            <div className="img-placeholder" onClick={() => setViewing(true)}>
              <i className="bi bi-gem"></i>
              <span className="no-img-text">Preview</span>
            </div>
          )}
        ...
        <div className="product-card-body">
          ...
          <div className="product-meta">
            ...
            <span>
              <i className="bi bi-tag"></i> {formatTag(item.TagNo)}
            </span>
          </div>
      ...
      {viewing && (
        <ProductLightbox item={item} imgSrc={imgSrc} onClose={() => setViewing(false)} />
      )}
    </>
  );
}
